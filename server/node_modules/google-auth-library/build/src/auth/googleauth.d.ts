 ...
 * config file.
 */
export declare type JSONClient = JWT | UserRefreshClient | BaseExternalAccountClient;
...
export declare class GoogleAuth {
    ...
    cachedCredential: JSONClient | Compute | null;
    /**
     ...
     */
    getClient(options?: DeprecatedGetClientOptions): Promise<Compute | JWT | UserRefreshClient | BaseExternalAccountClient>;
    /**
